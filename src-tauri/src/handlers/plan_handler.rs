use crate::{db, models::{page::Page, plan::PlanResponse}, repositories};

#[tauri::command]
pub async fn get_plans_by_game_id(game_id: String, limit: i32, page: i32) -> Result<Page<PlanResponse>, String> {
